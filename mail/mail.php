...
$sendingAccountUsername     = 'website@ecowastedigester.com';
$sendingAccountPassword     = 'p@55w0rd';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'rebeccasheeler@gmail.com'; // REQUIRED value.
$recipientName              = 'Michael Rosa';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from Ecowaste Digester Website'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Ecowaste Digester';                // REQUIRED value. This is used when a name or email is not collected from the website form
